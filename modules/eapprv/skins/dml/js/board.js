...
jQuery(function($){
// NanumPen Font
	$('body').append('<div class="fontcheckWrp"><p id="fontcheck_np1" style="font-family:\'³ª´®¼Õ±Û¾¾ Ææ\',\'Nanum Pen Script\',np,monospace,Verdana !important">Sketchbook5, ½ºÄÉÄ¡ºÏ5</p><p id="fontcheck_np2" style="font-family:monospace,Verdana !important">Sketchbook5, ½ºÄÉÄ¡ºÏ5</p></div>');
	var bd = $('div.bd');
